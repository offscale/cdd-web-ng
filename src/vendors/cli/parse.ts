...
import { SwaggerSpec, PathItem, SpecOperation, Parameter, ServerObject } from '../../core/types/index.js';
                    ...
                    if (name === 'description' && args[0]) {
                        ...
                        if (p.getExpression().getText() === 'program') isProgramDesc = true;
                             ...
                             if (pCall.getExpression().getKind() === SyntaxKind.PropertyAccessExpression) {
                                  ...
                                  if (pCallProp.getExpression().getText() === 'program' && pCallProp.getName() === 'name') {
                                      isProgramDesc = true;
                                  }
                             }
                        }

        ...
        it('should handle blob, arraybuffer, and text response types', async () => {
            ...
            expect(
                serviceClass!
                    ...
                    .map(s => s.getText())
                    .join('\\n'),
            ).toContain('resolve(buffer as string | number | boolean | object | undefined | null)');
            expect(
                serviceClass!
                    .getMethod('getBuffer')!
                    .getStatements()
            ...
            expect(
                serviceClass!
                    ...
                    .map(s => s.getText())
                    .join('\\n'),
            ).toContain("resolve(buffer.toString('utf-8') as string | number | boolean | object | undefined | null)");
        });
